  ...
  return (
    <div className="container relative min-h-screen flex-col items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <div className="lg:p-8 flex items-center justify-center relative min-h-screen lg:min-h-0 bg-background">
        <div className="relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-indigo-500/5 blur-[120px] pointer-events-none absolute" />
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[380px] px-8 sm:px-0 relative z-10">
          <div className="flex flex-col space-y-2 text-center lg:text-left">
            ...
            <p className="text-sm text-muted-foreground">
              Enter your details below to create your new workspace.
            </p>
          </div>
